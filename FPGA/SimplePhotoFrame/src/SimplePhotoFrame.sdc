...
# PLL 出力クロック
create_generated_clock -name sysclk   -source [get_ports {clk27m}] -master_clock clk27m -multiply_by 4 -divide_by 1 [get_nets {sysclk}]
create_generated_clock -name serialclk   -source [get_ports {clk27m}] -master_clock clk27m -multiply_by 8 -divide_by 1 [get_nets {serialclk}]
